...
def go_to_menu():
    print("음식 페이지 로드중...")
    driver.find_element_by_xpath('//*[@id="content"]/div[2]/div[1]/ul/li[1]/a').click()
    time.sleep(2)
    print("리뷰 페이지 로드 완료!")
...
def save_pickle_csv(location, yogiyo_df):
    yogiyo_df.to_csv("C://Users/Administrator/Documents/GitHub/python_Crolling/요기요/data/{}_{}_df.csv".format(location[0], location[1]))
    pickle.dump(yogiyo_df, open("C://Users/Administrator/Documents/GitHub/python_Crolling/요기요/data/{}_{}_df.csv/{}_{}_df.pkl".format(location[0], location[1]), "wb"))
...
parser.add_argument("--num", required=False, default=3, help="option for restaurant number")
